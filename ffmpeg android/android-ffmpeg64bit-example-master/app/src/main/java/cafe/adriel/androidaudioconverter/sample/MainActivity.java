...
public class MainActivity extends AppCompatActivity {
    ...
    public void convertAudio(View v) {
        ...
        File wavFile = new File(Environment.getExternalStorageDirectory(), "/audio_test/delivery.avi");
...
//        };
        ...
        AndroidAudioConverter.load(this, Environment.getExternalStorageDirectory() + "/audio_test/delivery.avi");
