...
import com.example.harang.calibration.CalibrationDataStorage;
...
public class GazeTrackerManager {
  ...
  static private com.example.harang.GazeTrackerManager mInstance = null;
  ...
  static public com.example.harang.GazeTrackerManager makeNewInstance(Context context) {
    if (mInstance != null) {
      mInstance.deinitGazeTracker();
    }
    mInstance = new com.example.harang.GazeTrackerManager(context);
    return mInstance;
  }

  static public com.example.harang.GazeTrackerManager getInstance() {
    return mInstance;
  }
