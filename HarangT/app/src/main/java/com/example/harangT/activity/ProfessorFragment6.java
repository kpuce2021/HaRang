...
public class ProfessorFragment6 extends Fragment {
    public static ProfessorFragment6 newInstance() {
        return new ProfessorFragment6();
    }
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.p_fragment6, container, false);
    ...
    private void accessDB(){
        ...
        ProfessorAllTypeVideoListRequset request = new ProfessorAllTypeVideoListRequset(p_id, responseListener);
