...
import com.example.harangT.calibration.CalibrationDataStorage;
...
public class GazeTrackerManager {
  ...
  static private com.example.harangT.GazeTrackerManager mInstance = null;
  ...
  static public com.example.harangT.GazeTrackerManager makeNewInstance(Context context) {
    if (mInstance != null) {
      mInstance.deinitGazeTracker();
    }
    mInstance = new com.example.harangT.GazeTrackerManager(context);
    return mInstance;
  }

  static public com.example.harangT.GazeTrackerManager getInstance() {
    return mInstance;
  }
