...
public class EnrollmentUpdateRequest extends StringRequest {
    ...
    public EnrollmentUpdateRequest(String p_id, ArrayList<String> checkList, Response.Listener<String> listener) {
