...
Java_kr_ac_kpu_opencvtest5_MainActivity_ConvertRGBtoGray(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_kr_ac_kpu_opencvtest5_MainActivity_Detect(JNIEnv *env, jobject thiz){
