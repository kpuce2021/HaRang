...
import com.example.harangS.calibration.CalibrationDataStorage;
...
public class GazeTrackerManager {
  ...
  static private com.example.harangS.GazeTrackerManager mInstance = null;
  ...
  String SEESO_LICENSE_KEY = "dev_ywpiuqvlb29243skwqstp78u3gh6gdckm5l0zyzf";

  static public com.example.harangS.GazeTrackerManager makeNewInstance(Context context) {
    if (mInstance != null) {
      mInstance.deinitGazeTracker();
    }
    mInstance = new com.example.harangS.GazeTrackerManager(context);
    return mInstance;
  }

  static public com.example.harangS.GazeTrackerManager getInstance() {
    return mInstance;
  }
