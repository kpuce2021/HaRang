...
Java_com_example_harang_CpptestActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_example_harang_EyeblinkActivity_ConvertRGBtoGray(JNIEnv *env, jobject thiz,
...
Java_com_example_harang_EyeblinkActivity_loadCascade(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_harang_EyeblinkActivity_detect(JNIEnv *env, jobject thiz,
    ...
    float resizeRatio = resize(img_gray, img_resize, 400); //맨 뒤 숫자로 크기 줄이면 정확도 올라감

    //CascadeClassifier::detectMultiScale( img_resize, faces, 1.1, 2, 0|CASCADE_SCALE_IMAGE, Size(30, 30) );
